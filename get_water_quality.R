...
#system(paste('wget','http://106.37.208.244:10001/Home/GetSectionDataList?&page=1&rows=9999','-O',path))
#http://106.37.208.244:10001/Home/GetSectionDataList?taskMonth=202101&page=1&rows=9999
...
# url <- "http://envi.ckcest.cn/environment/WaterMonitor/index.action"
# re1 <- jsonlite::fromJSON(url, simplifyVector = FALSE)
# re1 <- as.data.frame(rlist::list.rbind(re1$data))
